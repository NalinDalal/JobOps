...
## How this applies to JobOps

- **README** answers: "What is this job hunting agent, how do I set it up, and how do I run my first scan/evaluate/tailor/track workflow?"
- **AGENTS.md** answers: "I'm an AI agent about to execute a job-hunting task — what scripts exist, what flags they accept, what the output format is, and what rules I must follow (no auto-submit, score honestly, etc.)"
- The glossary in AGENTS.md defines JobOps-specific terms like "5-dimension scoring", "tailor", "tracker", "portal", "blacklist/whitelist"
- Non-negotiables: never auto-submit, never fabricate CV content, always run scripts instead of guessing results, local-first data storage
