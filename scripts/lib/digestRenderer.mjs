 ...
 * Outreach consolidated, not repeated per job.
 *
 * Typography:
 *   11px/600/uppercase — section labels
 *   18px/700 — headings
 *   15px/600 — titles
 *   13–14px/400 — body
 *   11–12px — meta
  ...
  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0 0 20px;">
    <tr>
      <td style="padding:20px 0 0;">
        ...
        <p style="margin:0 0 4px;font-family:${S.font};font-size:13px;color:${S.textSecondary};">${esc(vm.date.long)}</p>
        <p style="margin:0;font-family:${S.font};font-size:12px;color:${S.textTertiary};">${esc(roles)} · ${esc(locations)}</p>
      </td>
    </tr>
  </table>`;
}
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
          <tr>
            ...
            <td style="vertical-align:top;">
              <p style="margin:0 0 2px;font-family:${S.font};font-size:11px;font-weight:600;letter-spacing:0.06em;text-transform:uppercase;color:${verdictColor};">${esc(match.verdict)}</p>
              <p style="margin:0 0 2px;font-family:${S.font};font-size:16px;font-weight:600;color:${S.textPrimary};line-height:1.3;">
                <a href="${esc(match.url)}" style="color:${S.textLink};text-decoration:none;">${esc(match.title)}</a>
              </p>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:12px 0 0;">
                <tr>
                  <td style="padding:0;">
                    <a href="${esc(match.url)}" style="display:inline-block;font-family:${S.font};font-size:13px;font-weight:600;color:#fff;background:${S.accent};padding:7px 16px;border-radius:6px;text-decoration:none;">View posting</a>
                  </td>
                </tr>
              </table>
            </td>
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
          <tr>
            ...
            <td style="vertical-align:top;text-align:right;white-space:nowrap;padding-left:12px;">
              ...
              <p style="margin:6px 0 0;"><a href="${esc(m.url)}" style="font-family:${S.font};font-size:11px;color:${S.textLink};text-decoration:underline;text-underline-offset:2px;">View</a></p>
            </td>
          </tr>
        </table>
      </td>
  ...
  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:20px 0 0;">
    <tr>
      <td style="padding:16px 0 0;border-top:1px solid ${S.divider};">
        <p style="margin:0;font-family:${S.font};font-size:11px;color:${S.textTertiary};">JobOps · ${vm.footer.scanned} scanned · ${vm.footer.filtered} surfaced · Human review required</p>
      </td>
    </tr>
  </table>`;
}
