# Reference: Agent Docs Writer Skill

> This is a reference skill for writing README/AGENTS.md pairs. The **active JobOps skill** is `.opencode/skills/jobops/SKILL.md`.
