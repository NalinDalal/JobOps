...
import type { Job, DigestViewModel, DigestMatch, DigestSummary, MatchScore, AcceleratorResearchSection } from "./types";
...
import type { ViewModelOptions, OutreachGroup, PeopleSearchUrl, SkillSignal } from "./types";
...
const WEB_PRIORITY_SKILLS = [
  "typescript", "javascript", "react", "next", "node", "tailwind css",
  "elysia", "express", "postgresql", "prisma", "mongodb", "redis",
  "docker", "kubernetes", "aws", "github actions", "bun", "jest", "bash", "linux",
];
...
const SENIOR_INDICATORS = [
  ...
  "head of", "architect", "fellow", "distinguished", "staff engineer",
  "principal engineer", "iii", "iv", "v", "5+ years", "6+ years", "7+ years", "8+ years",
];
...
const SKILL_GAP_BLACKLIST = new Set([
  "software", "engineer", "engineering", "development", "developer", "technology",
  "technical", "system", "systems", "platform", "platforms", "service", "services",
  "application", "applications", "project", "projects", "team", "teams", "company",
  "companies", "product", "products", "data", "information", "process", "solutions",
  "solution", "build", "building", "built", "working", "experience", "knowledge",
  "understanding", "ability", "skills", "familiar", "proficiency", "proficient",
  "expertise", "expert", "requirement", "requirements", "qualification",
  "qualifications", "responsibility", "responsibilities", "duties", "role",
  "environment", "culture", "collaboration", "communication", "problem", "solving",
  "analysis", "analytical", "design", "architecture", "infrastructure", "management",
  "leadership", "mentoring", "agile", "scrum", "methodology", "best", "practices",
  "testing", "quality", "debugging", "troubleshooting", "documentation", "maintenance",
  "performance", "scalability", "reliability", "integration", "deployment", "automation",
  "innovation", "optimization", "improvement", "initiative", "proactive", "self-motivated",
  "detail", "oriented", "organized", "efficient", "independent", "collaborative", "cross-functional",
]);
