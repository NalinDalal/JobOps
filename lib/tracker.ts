...
import type { TrackerRow, ApplicationStatus, Application } from "./types";
...
export async function runTracker(
    ...
    switch (command) {
        ...
        case "add": {
            ...
            if (!company || !role) {
                console.error(
                    "Usage: tracker add --company <company> --role <role>",
                );
                return;
            }
        ...
        case "update": {
            ...
            if (!company || !status) {
                console.error(
                    "Usage: tracker update --company <company> --status <status>",
                );
                return;
            }
        ...
        case "interview": {
            ...
            if (!company || !stage) {
                console.error(
                    "Usage: tracker interview --company <company> --stage <stage>",
                );
                return;
            }
        ...
        case "outcome": {
            ...
            if (!company || !outcome) {
                console.error(
                    "Usage: tracker outcome --company <company> --outcome <outcome>",
                );
                return;
            }
        ...
        case "followup": {
            ...
            if (!company || !note) {
                console.error(
                    "Usage: tracker followup --company <company> --note <note>",
                );
                return;
            }
        ...
        default:
            console.log(
                "Available commands: list, add, update, interview, outcome, followup, export",
            );
    }
}
