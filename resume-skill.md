# Reference: Elite Technical Resume Protocol

> This is a reference skill for ATS-optimized resume generation. The **active JobOps skill** is `.opencode/skills/jobops/SKILL.md`, and CV tailoring is handled by `scripts/tailor.mjs`.
